...
![](\assets\img\vulnhub\Devguru\gitImage.png)
...
![](\assets\img\vulnhub\Devguru\database.png)

inside it you can find `sqlCreds` using this now login to **adminer.php**

![](\assets\img\vulnhub\Devguru\sql.png)


![](\assets\img\vulnhub\Devguru\adminr.png)

![](\assets\img\vulnhub\Devguru\explomit.png)
...
![](\assets\img\vulnhub\Devguru\Done.png)
