...
![]({{site.baseurl}}\assets/img/tryhackme/internal/brute.png)

**afterlogin**

![]({{site.baseurl}}\assets/img/tryhackme/internal/writecode.png)
...
![]({{site.baseurl}}\assets/img/tryhackme/internal/curl.png)

![]({{site.baseurl}}\assets/img/tryhackme/internal/shell.png)
...
on pty user Linpeas
 ...
 ![]({{site.baseurl}}\assets/img/tryhackme/internal/port.png)
...
![]({{site.baseurl}}\assets/img/tryhackme/internal/opt.png)

explored the phpmyadmin but no user hashes found

 ![]({{site.baseurl}}\assets/img/tryhackme/internal/php.png)

#PortForwording

![]({{site.baseurl}}\assets/img/tryhackme/internal/portforword.png)

![]({{site.baseurl}}\assets/img/tryhackme/internal/local host.png)
